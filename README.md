...
В папке clean лежит плохораспознанный файл - "slovar.txt" (и промежуточный вариант - "slovar_new.txt") с текстом словаря и программа, с помощью которых файл был чищен.
