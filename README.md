...
* распознать текст словаря с помощью ABBY FineReader, включая особые символы и диакритические знаки, почистить его регулярными выражениями. Статьи с одинаковыми словами (омонимы) собирать в один ключ, значения пометить как 1., 2., ...
...
* Текст словаря преобразуется в питоновский словарь: ключ - табасаранское слово, значение - все после
